...
const Services: React.FC = () => {
   return (
    <div id='services' className='w-full h-[720px] flex justify-center items-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-12 sm:py-16 lg:py-0'>
      ...
      <div className='w-full max-w-7xl flex flex-col gap-6 sm:gap-8 md:gap-10 lg:gap-12'>
        ...
        <div className='text-[#3AC3F9] font-bold'>
          ...
          <p className='text-xs sm:text-sm md:text-base lg:text-sm 2xl:text-base text-[#3AF9EF] font-medium'>
